# vpc
resource "aws_vpc" "home_care_navi_second" {
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "home_care_navi_second-public-subnet"
  }
}
...
resource "aws_subnet" "public_other" {
  ...
  tags = {
    Name = "home_care_navi_second-public-dammy-subnet"
  }
}

# internet_gateway
resource "aws_internet_gateway" "home_care_navi_second" {
  vpc_id = aws_vpc.home_care_navi_second.id

  tags = {
    Name = "home_care_navi_second-gateway"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "home_care_navi_second-public-route-table"
  }
}
...
resource "aws_route" "public" {
  ...
  gateway_id = aws_internet_gateway.home_care_navi_second.id
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "home_care_navi_second-private-subnet"
  }
}
...
resource "aws_subnet" "private_other" {
  ...
  tags = {
    Name = "home_care_navi_second-private-other-subnet"
  }
}
...
resource "aws_route_table" "private" {
  ...
  tags = {
    Name = "home_care_navi_second-private-route-table"
  }
}
